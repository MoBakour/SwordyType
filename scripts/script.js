/**
 * SwordyType © 2021 - present | Swordax
 * @swordax.sy
 * Discord: Swordax#5756
 *
 * This code is a property of Swordax Sy
 *
        ...
        case "я":
            ...
            if (
                ...
                if (
                    document
                        .querySelector(
                            `.words span:nth-of-type(${counter - 1})`
                        )
                        .classList.contains("space") &&
                    !backWord
                )
